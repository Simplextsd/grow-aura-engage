...
export default function CreateInvoiceDialog({
  ...
  useEffect(() => {
    ...
    if (isNew === "true") {
      setOpen(true);
      if (tName) setFormData((prev) => ({ ...prev, template_id: tName }));
    }
  }, [searchParams]);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-[98vw] lg:max-w-[1400px] h-[96vh] flex flex-col bg-[#020617] text-white border-slate-800 p-0 overflow-hidden rounded-2xl shadow-2xl [&>button]:hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center pl-1">
                ...
                <Button onClick={addPassengerRow} size="sm" className="h-7 bg-orange-600 hover:bg-orange-500 text-[10px] font-bold">
                  + ADD ROW
                </Button>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center pl-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Button onClick={addFlightRow} size="sm" className="h-7 bg-blue-600 hover:bg-blue-500 text-[10px] font-bold">
                    + ADD ROW
                  </Button>
                </div>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center pl-1">
                ...
                <Button onClick={addHotelRow} size="sm" className="h-7 bg-emerald-600 hover:bg-emerald-500 text-[10px] font-bold">
                  + ADD ROW
                </Button>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center pl-1">
                ...
                <Button onClick={addTransportRow} size="sm" className="h-7 bg-purple-600 hover:bg-purple-500 text-[10px] font-bold">
                  + ADD ROW
                </Button>
              </div>
            ...
            <div className="col-span-4 p-5 bg-slate-900/40 border border-slate-800 rounded-2xl space-y-4 shadow-xl border-l-4 border-l-orange-500">
              ...
              <div className="space-y-1">
                ...
                <Select value={formData.payment_method} onValueChange={(v) => setFormData({ ...formData, payment_method: v })}>
                  <SelectTrigger className="h-9 bg-slate-950 border-slate-800 text-[10px]">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="bg-slate-900 text-white border-slate-700">
        ...
        <div className="flex-none p-4 bg-slate-950 border-t border-slate-800 flex justify-end items-center gap-6 px-10">
          ...
          >
            <Save className="h-4 w-4 mr-2" /> Save & Generate {formData.generate_stripe_link ? "Stripe Link" : "Invoice"}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
